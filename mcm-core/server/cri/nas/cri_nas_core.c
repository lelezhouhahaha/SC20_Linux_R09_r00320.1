...
void cri_nas_update_voice_network_info()
{
    ...
    if ( cri_nas_core_rte_info.cri_nas_voice_rte == CRI_NAS_RTE_CDMA )
    {
        ...
        if ( cri_nas_core_sys_info->cdma_sys_info.cdma_specific_sys_info.bs_info_valid == TRUE )
        {
            snprintf(bsid,sizeof(bsid),
                "%d",
                 cri_nas_core_sys_info->cdma_sys_info.cdma_specific_sys_info.bs_info.base_id);

            strlcpy(cri_nas_rte_cdma_reg_info[CRI_NAS_RTE_SERVICE_VOICE]->bsid, bsid,sizeof(cri_nas_rte_cdma_reg_info[CRI_NAS_RTE_SERVICE_VOICE]->bsid));
        }
        if ( cri_nas_core_sys_info->cdma_sys_info.cdma_specific_sys_info.ccs_supported_valid == TRUE )
        {
            cri_nas_rte_cdma_reg_info[CRI_NAS_RTE_SERVICE_VOICE]->css = cri_nas_core_sys_info->cdma_sys_info.cdma_specific_sys_info.ccs_supported;
        }
        if ( cri_nas_core_sys_info->cdma_sys_info.cdma_hdr_only_sys_info.is_sys_prl_match_valid == TRUE )
        {
            cri_nas_rte_cdma_reg_info[CRI_NAS_RTE_SERVICE_VOICE]->inPRL = cri_nas_core_sys_info->cdma_sys_info.cdma_hdr_only_sys_info.is_sys_prl_match;
        }
        if ( cri_nas_core_sys_info->cdma_sys_info.common_sys_info.is_sys_forbidden_valid == TRUE )
        {
            cri_nas_rte_cdma_reg_info[CRI_NAS_RTE_SERVICE_VOICE]->forbidden = cri_nas_core_sys_info->cdma_sys_info.common_sys_info.is_sys_forbidden;
        }
    }
...
void cri_nas_update_data_network_info()
{
    ...
    if ( cri_nas_core_rte_info.cri_nas_data_rte == CRI_NAS_RTE_GSM )
    {
        if ( cri_nas_core_sys_info->gsm_sys_info.threegpp_specific_sys_info.lac_valid == TRUE )
        {
            snprintf(lac,sizeof(lac),
    ...
    if ( cri_nas_core_rte_info.cri_nas_data_rte == CRI_NAS_RTE_WCDMA )
    {
        if ( cri_nas_core_sys_info->wcdma_sys_info.threegpp_specific_sys_info.lac_valid == TRUE )
        {
            snprintf(lac,sizeof(lac),
    ...
    if ( cri_nas_core_rte_info.cri_nas_data_rte == CRI_NAS_RTE_CDMA )
    {
        if ( cri_nas_core_sys_info->cdma_sys_info.cdma_specific_sys_info.cdma_sys_id_valid == TRUE )
        {
            snprintf(sid,sizeof(sid),
        ...
        if ( cri_nas_core_sys_info->cdma_sys_info.cdma_specific_sys_info.bs_info_valid == TRUE )
        {
            ...
            strlcpy(cri_nas_rte_cdma_reg_info[CRI_NAS_RTE_SERVICE_DATA]->bsid, bsid,sizeof(cri_nas_rte_cdma_reg_info[CRI_NAS_RTE_SERVICE_DATA]->bsid));
        }
        if ( cri_nas_core_sys_info->cdma_sys_info.cdma_specific_sys_info.ccs_supported_valid == TRUE )
        {
            cri_nas_rte_cdma_reg_info[CRI_NAS_RTE_SERVICE_DATA]->css = cri_nas_core_sys_info->cdma_sys_info.cdma_specific_sys_info.ccs_supported;
        }
        if ( cri_nas_core_sys_info->cdma_sys_info.cdma_hdr_only_sys_info.is_sys_prl_match_valid == TRUE )
        {
            cri_nas_rte_cdma_reg_info[CRI_NAS_RTE_SERVICE_DATA]->inPRL = cri_nas_core_sys_info->cdma_sys_info.cdma_hdr_only_sys_info.is_sys_prl_match;
        }
        if ( cri_nas_core_sys_info->cdma_sys_info.common_sys_info.is_sys_forbidden_valid == TRUE )
        {
            cri_nas_rte_cdma_reg_info[CRI_NAS_RTE_SERVICE_DATA]->forbidden = cri_nas_core_sys_info->cdma_sys_info.common_sys_info.is_sys_forbidden;
        }
    }

    if ( cri_nas_core_rte_info.cri_nas_data_rte == CRI_NAS_RTE_LTE)
    {
        if ( cri_nas_core_sys_info->lte_sys_info.threegpp_specific_sys_info.lac_valid == TRUE )
        {
            snprintf(lac,sizeof(lac),
...
void* cri_nas_core_nw_scan_helper(void *nw_scan_resp_msg)
{
    ...
    memset(long_eons, NIL, sizeof(long_eons));
    memset(short_eons, NIL, sizeof(short_eons));
                                            ...
                                            uint8_t is_nw_sel_in_progress)
{
    ...
    if ( cri_error == CRI_ERR_NONE_V01 )
    {
        ...
        nwreg_indications_qmi_request.reg_network_time       = enable_indications; // only when online?
        ...
        nwreg_indications_qmi_request.reg_current_plmn_name       = enable_indications; // while online?
        ...
        nwreg_indications_qmi_request.reg_rf_band_info = enable_indications;
        ...
        sys_reg_req_msg.limit_so_mask_change_ind = (enable_indications != 0)? FALSE:TRUE;
...
void cri_nas_core_fill_nitz_time_resp(uint8_t *nitz_time_valid, char *nitz_time, uint8_t *abs_time_valid, uint64_t *abs_time, uint8_t *leap_sec_valid, int8_t *leap_sec)
{
    ...
    do
    {
        ...
        else if((NAS_TRI_TRUE_V01 != cri_nas_sib16_acquired_status()) && cri_nas_nw_network_time_info)
        {
...
uint8_t cri_nas_core_fill_network_time_ind(uint8_t *nitz_time_valid, char *nitz_time, uint8_t *abs_time_valid, uint64_t *abs_time, uint8_t *leap_sec_valid, int8_t *leap_sec)
{
    ...
    do
    {
        ...
        if(NAS_TRI_TRUE_V01 != sib16_acquired)
        {
            if(cri_nas_nw_network_time_info->time_zone_valid)
            {
                time_zone = cri_nas_nw_network_time_info->time_zone;
...
cri_core_error_type cri_nas_set_dual_standby_handler(cri_core_context_type cri_core_context, int card,
        const void *hlos_cb_data, hlos_resp_cb_type hlos_resp_cb)
{
    cri_core_error_type ret_val = QMI_ERR_INTERNAL_V01;
    ...
    req_msg.default_data_subs = card;

    req_msg.dds_duration_valid = TRUE;
    req_msg.dds_duration = 0;
    ...
    if(QMI_ERR_NONE_V01 != ret_val)
    {
        UTIL_LOG("cri_nas_set_dual_standby_handler error - %d\n", ret_val);
    }
