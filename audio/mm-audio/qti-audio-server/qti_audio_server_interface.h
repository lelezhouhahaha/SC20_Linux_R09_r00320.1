...
class Iqti_audio_server: public ::android::IInterface {
    public:
       ...
       virtual int qahw_set_param_data(const qahw_module_handle_t *hw_module,
        ...
        virtual int qahw_create_audio_loopback(qahw_module_handle_t *hw_module,
                                uint32_t input,
                                const struct audio_config *source,
                                uint32_t output,
                                const struct audio_config *sink) = 0;
        virtual int qahw_release_audio_loopback(qahw_module_handle_t *hw_module) = 0;
