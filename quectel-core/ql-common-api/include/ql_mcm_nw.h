...
E_QL_ERROR_CODE_T QL_MCM_NW_ScreenStateHandler(
        nw_client_handle_type h_nw,
        uint8_t is_screen_off
);

E_QL_ERROR_CODE_T QL_MCM_NW_SetSystemSelectionPreference(nw_client_handle_type h_nw);
E_QL_ERROR_CODE_T QL_MCM_NW_SetSysSelEmergencyMode(nw_client_handle_type h_nw, int emergency_mode);

E_QL_ERROR_CODE_T QL_MCM_NW_SwitchDataSubscription(nw_client_handle_type h_nw, int card);
