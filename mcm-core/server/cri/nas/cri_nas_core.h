...
typedef struct
{
    ...
    uint8_t radio_if_valid;
    nas_radio_if_enum_v01 radio_if;
} cri_nas_nw_network_time_info_type;
...
typedef struct
{
    ...
    uint8_t daylt_sav_adj_valid;
    uint8_t daylt_sav_adj;
} cri_nas_nw_lte_sib16_network_time_info_type;

cri_nas_nw_network_time_info_type *cri_nas_nw_network_time_info;
cri_nas_nw_lte_sib16_network_time_info_type *cri_nas_nw_lte_sib16_network_time_info;
...
cri_core_error_type cri_nas_set_dual_standby_handler(cri_core_context_type cri_core_context, const int card, const void *hlos_cb_data, hlos_resp_cb_type hlos_resp_cb);
#endif
