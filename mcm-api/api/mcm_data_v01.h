...
/** @addtogroup mcm_data_messages
    @{
  */
/** Request message; Gets apn name with the
           specified profile index. */
typedef struct {
  /* Mandatory */
  /*  MCM Data Profile Index */
  uint8_t profile_index;
  /**< Profile index for which to get the apn name. @newpagetable */
}mcm_data_get_apn_name_req_msg_v01;  /* Message */
...
typedef struct {
  ...
  /* Optional */
  /*  MCM Data Device name */
  uint8_t apn_name_valid;  /**< Must be set to TRUE if device_name is being passed. */
  uint32_t apn_name_len;  /**< Must be set to # of elements in device_name */
  char apn_name[MCM_DATA_MAX_APN_LEN_V01];
  /**<   Device name. */
}mcm_data_get_apn_name_rsp_msg_v01;  /* Message */
...
#define MCM_DATA_GET_APN_NAME_REQ_V01 0x010C
#define MCM_DATA_GET_APN_NAME_RSP_V01 0x010C
#define MCM_DATA_UNSOL_EVENT_IND_V01 0x010D
