...
*/
  ...
  //add by peeta
  {MCM_NW_SET_SYS_SEL_PREF_REQ_V01, QMI_IDL_TYPE16(4, 29), 8},
  {MCM_NW_SET_DUAL_STANDBY_PREF_REQ_V01, QMI_IDL_TYPE16(4, 31), 4},
/** 
    @}
*/
...
*/
  ...
  //add by peeta
  {MCM_NW_SET_SYS_SEL_PREF_RESP_V01, QMI_IDL_TYPE16(4, 30), 11},
  {MCM_NW_SET_DUAL_STANDBY_PREF_RESP_V01, QMI_IDL_TYPE16(4, 32), 11},
/** 
    @}
*/
