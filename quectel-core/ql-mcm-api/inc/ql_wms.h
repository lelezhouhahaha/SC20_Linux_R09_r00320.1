...
typedef struct
{
  bool      set_primary;        /**< Indicates whether to set the client as 
                                        the primary client. */
  bool      use_client_memory;  /**< Indicates whether to use the client 
                                        memory. */
...
*/
typedef bool (*wms_msg_transport_mo_sms_cb_type) (
...
typedef struct 
{
  ...
  bool                         is_active; /**< Set indication active/inactive. */
...
typedef struct wms_gw_cb_dcs_s
{
  ...
  bool                     is_compressed;   /**< If the group is defined. */
  ...
  bool                     is_udh_present;  /**< If the group is defined. */
...
typedef struct wms_ip_address_s
{
  ...
  bool             is_valid;     /**< Indicates whether the IP address entry 
                                         is valid. */
...
{
  bool                       is_broadcast; /**< Indicates whether this a cell 
                                                   broadcast message. */
...
(
  ...
  bool                      *shared    /**< Indicates whether the message can 
...
{
  bool                      reading_advised;   /**< Indicates whether reading 
                                                       is advised. */
  bool                      reading_optional;  /**< Indicates whether reading 
                                                       is optional. */
