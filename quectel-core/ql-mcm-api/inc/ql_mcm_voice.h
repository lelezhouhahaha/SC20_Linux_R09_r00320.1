...
typedef enum 
{
    E_QL_MCM_VOICE_E911_INACTIVE = 0, /* *<  E911 INACTIVE. */
    E_QL_MCM_VOICE_E911_ACTIVE = 1, /* *<  E911 INACTIVE. */
}ql_voice_e911_state_t;

typedef struct 
{
    ql_voice_e911_state_t   state;
}ql_mcm_voice_e911_state_t;
...
}E_QL_MCM_VOICE_ECALL_EVENT_OTHER_STATE_T;
...
typedef struct 
{
  ...
  uint8_t 											  ecall_event_other_state_valid; 
  E_QL_MCM_VOICE_ECALL_EVENT_OTHER_STATE_T			  ecall_event_other_state;	  /**<	 event of eCall orher state.*/
  //--------------added end
...
typedef ql_mcm_voice_e911_state_t ql_mcm_voice_e911_state_ind;
