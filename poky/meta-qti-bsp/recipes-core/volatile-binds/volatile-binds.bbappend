...
/systemrw/ql_power_manager.conf /etc/ql_power_manager.conf\n\
/systemrw/sound_manager.ini /etc/sound_manager.ini\n\
/systemrw/network_manager.ini /etc/network_manager.ini\n\
/systemrw/supl_test.conf /etc/supl_test.conf\n\
...
/systemrw/misc/soundlib /etc/misc/soundlib/\n\
