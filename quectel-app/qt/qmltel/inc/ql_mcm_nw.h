...
typedef enum{
    E_QL_MCM_NW_MODE_PREF_GSM = 4,
    E_QL_MCM_NW_MODE_PREF_UMTS = 8,
    E_QL_MCM_NW_MODE_PREF_LTE = 16
}E_QL_MCM_NW_MODE_PREF_T;

typedef struct 
{
    E_QL_MCM_NW_MODE_PREF_T mode_pref;                                    /**<   Radio technology.*/
