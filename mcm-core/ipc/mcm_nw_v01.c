...
// add by peeta
static const uint8_t mcm_nw_set_sys_sel_pref_req_msg_data_v01[] = {
    QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(mcm_nw_set_sys_sel_pref_req_msg_v01, emergency_mode) - QMI_IDL_OFFSET8(mcm_nw_set_sys_sel_pref_req_msg_v01, emergency_mode_valid)),
    0x10,
    QMI_IDL_GENERIC_1_BYTE,
    QMI_IDL_OFFSET8(mcm_nw_set_sys_sel_pref_req_msg_v01, emergency_mode),

    QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(mcm_nw_set_sys_sel_pref_req_msg_v01, change_duration) - QMI_IDL_OFFSET8(mcm_nw_set_sys_sel_pref_req_msg_v01, change_duration_valid)),
    0x11,
    QMI_IDL_GENERIC_1_BYTE,
    QMI_IDL_OFFSET8(mcm_nw_set_sys_sel_pref_req_msg_v01, change_duration),

    QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(mcm_nw_set_sys_sel_pref_req_msg_v01, srv_domain_pref) - QMI_IDL_OFFSET8(mcm_nw_set_sys_sel_pref_req_msg_v01, srv_domain_pref_valid)),
    0x12,
    QMI_IDL_GENERIC_1_BYTE,
    QMI_IDL_OFFSET8(mcm_nw_set_sys_sel_pref_req_msg_v01, srv_domain_pref),
};

static const uint8_t mcm_nw_set_sys_sel_pref_resp_msg_data_v01[] = {
    QMI_IDL_TLV_FLAGS_LAST_TLV | 0x01,
    QMI_IDL_AGGREGATE,
    QMI_IDL_OFFSET8(mcm_nw_set_sys_sel_pref_resp_msg_v01, response),
    QMI_IDL_TYPE88(1, 0)
};

/* add by peeta
 */
static const uint8_t mcm_nw_set_dual_standby_pref_req_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x01,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(mcm_nw_set_dual_standby_pref_req_msg_v01, card)
};

static const uint8_t mcm_nw_set_dual_standby_pref_resp_msg_data_v01[] = {
    QMI_IDL_TLV_FLAGS_LAST_TLV | 0x01,
    QMI_IDL_AGGREGATE,
    QMI_IDL_OFFSET8(mcm_nw_set_dual_standby_pref_resp_msg_v01, response),
    QMI_IDL_TYPE88(1, 0)
};
...
*/
  ...
  //add by peeta
  {sizeof(mcm_nw_set_sys_sel_pref_req_msg_v01), mcm_nw_set_sys_sel_pref_req_msg_data_v01},
  {sizeof(mcm_nw_set_sys_sel_pref_resp_msg_v01), mcm_nw_set_sys_sel_pref_resp_msg_data_v01},

  //add by peeta
  {sizeof(mcm_nw_set_dual_standby_pref_req_msg_v01), mcm_nw_set_dual_standby_pref_req_msg_data_v01},
  {sizeof(mcm_nw_set_dual_standby_pref_resp_msg_v01), mcm_nw_set_dual_standby_pref_resp_msg_data_v01}
/** 
    @}
*/
};
