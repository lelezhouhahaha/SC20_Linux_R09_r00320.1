...
{
  bool                          more;                     /* TP-MMS */
  bool                          reply_path_present;       /* TP-RP */
  bool                          user_data_header_present; /* TP-UDHI */
  bool                          status_report_enabled;    /* TP-SRI */
...
{
  bool                           reject_duplicates;        /* TP-RD */
  bool                           reply_path_present;       /* TP-RP */
  bool                           user_data_header_present; /* TP-UDHI */
  bool                           status_report_enabled;    /* TP-SRR */
...
typedef struct wms_gw_status_report_s
{
  bool                       user_data_header_present; /* TP-UDHI */
  bool                       more;                     /* TP-MMS */
  bool                       status_report_qualifier;  /* TP-SRQ */
  wms_message_number_type       message_reference;        /* TP-MR */
