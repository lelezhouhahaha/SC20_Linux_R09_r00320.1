...
#define MIXER_XML_PATH_QRD_SKUH "/etc/mixer_paths_qrd_skuh.xml"
#define MIXER_XML_PATH_QRD_SKUI "/etc/mixer_paths_qrd_skui.xml"
#define MIXER_XML_PATH_QRD_SKUHF "/etc/mixer_paths_qrd_skuhf.xml"
#define MIXER_XML_PATH_SKUK "/etc/mixer_paths_skuk.xml"
#define MIXER_XML_PATH_SKUA "/etc/mixer_paths_skua.xml"
#define MIXER_XML_PATH_SKUC "/etc/mixer_paths_skuc.xml"
#define MIXER_XML_PATH_SKUE "/etc/mixer_paths_skue.xml"
#define MIXER_XML_PATH_SKUL "/etc/mixer_paths_skul.xml"
#define MIXER_XML_PATH_SKUS "/etc/mixer_paths_skus.xml"
#define MIXER_XML_PATH_SKUSH "/etc/mixer_paths_skush.xml"
#define MIXER_XML_PATH_QRD_SKUT "/etc/mixer_paths_qrd_skut.xml"
#define MIXER_XML_PATH_SKUM "/etc/mixer_paths_qrd_skum.xml"
#define MIXER_XML_PATH_SKU1 "/etc/mixer_paths_qrd_sku1.xml"
#define MIXER_XML_PATH_SKUN_CAJON "/etc/mixer_paths_qrd_skun_cajon.xml"
#define MIXER_XML_PATH_SKU3 "/etc/mixer_paths_qrd_sku3.xml"
#define MIXER_XML_PATH_AUXPCM "/etc/mixer_paths_auxpcm.xml"
#define MIXER_XML_PATH_AUXPCM "/etc/mixer_paths_auxpcm.xml"
#define MIXER_XML_PATH_I2S "/etc/mixer_paths_i2s.xml"
#define MIXER_XML_PATH_WCD9306 "/etc/mixer_paths_wcd9306.xml"
#define MIXER_XML_PATH_WCD9330 "/etc/mixer_paths_wcd9330.xml"
#define MIXER_XML_PATH_WCD9340 "/etc/mixer_paths_wcd9340.xml"
#ifdef LINUX_ENABLED
/* For LE platforms */
...
#define MIXER_XML_PATH_WCD9326 "/etc/mixer_paths_wcd9326.xml"
#define MIXER_XML_PATH_WCD9335 "/etc/mixer_paths_wcd9335.xml"
#define MIXER_XML_PATH_SKUN "/etc/mixer_paths_qrd_skun.xml"
#define PLATFORM_INFO_XML_PATH      "/etc/audio_platform_info.xml"
#define MIXER_XML_PATH_WCD9326_I2S "/etc/mixer_paths_wcd9326_i2s.xml"
#define MIXER_XML_PATH_WCD9326_I2S_TDM "/etc/mixer_paths_wcd9326_i2s_tdm.xml"
#define MIXER_XML_PATH_WCD9330_I2S "/etc/mixer_paths_wcd9330_i2s.xml"
...
int pcm_device_table[AUDIO_USECASE_MAX][2] = {
    ...
    [USECASE_AUDIO_TRANSCODE_LOOPBACK_RX] = {TRANSCODE_LOOPBACK_RX_DEV_ID, -1},//5
    [USECASE_AUDIO_TRANSCODE_LOOPBACK_TX] = {-1, TRANSCODE_LOOPBACK_TX_DEV_ID},//11
...
void *platform_init(struct audio_device *adev)
{
    ...
    property_get("ro.vendor.audio.sdk.fluencetype", my_data->fluence_cap, "none");
...
bool platform_check_backends_match(snd_device_t snd_device1, snd_device_t snd_device2)
{
    ...
    ALOGD("%s:snd_device1[%d] = %s, snd_device2[%d] = %s", __func__,
				snd_device1,
    ...
    if ((snd_device1 < SND_DEVICE_MIN) || (snd_device1 >= SND_DEVICE_OUT_END)) {
        ALOGE("[%s:%d] Invalid snd_device = %d", __func__, __LINE__, snd_device1);
        return false;
    }
    if ((snd_device2 < SND_DEVICE_MIN) || (snd_device2 >= SND_DEVICE_OUT_END)) {
        ALOGE("[%s:%d] Invalid snd_device2 = %d", __func__, __LINE__, snd_device2);
        return false;
    }
    ...
    ALOGD("%s: be_itf1 = %s, be_itf2 = %s, match %d", __func__, be_itf1, be_itf2, result);
    return result;
}
...
snd_device_t platform_get_output_snd_device(void *platform, struct stream_out *out)
{
    ...
    ALOGD("%s: enter: output devices(%#x)", __func__, devices);
    if (devices == AUDIO_DEVICE_NONE ||
        devices & AUDIO_DEVICE_BIT_IN) {
        ALOGD("%s: Invalid output devices (%#x)", __func__, devices);
        goto exit;
    }
...
exit:
    ALOGD("%s: exit: snd_device(%s)", __func__, device_table[snd_device]);
    return snd_device;
}
...
snd_device_t platform_get_input_snd_device(void *platform, audio_devices_t out_device)
{
    ...
    ALOGD("%s: enter: out_device(%#x) in_device(%#x) channel_count (%d) channel_mask (0x%x)",
...
exit:
    ALOGD("%s: exit: in_snd_device(%s)", __func__, device_table[snd_device]);
    return snd_device;
}
    ...
    struct audio_usecase *usecase, snd_device_t snd_device)
{
    ...
    for (i = 0; i < num_devices; i++) {
        ALOGD("%s: becf: new_snd_devices[%d] is %s", __func__, i,
