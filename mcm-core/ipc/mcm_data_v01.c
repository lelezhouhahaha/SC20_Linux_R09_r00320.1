...
static const uint8_t mcm_data_get_apn_name_req_msg_data_v01[] = {
  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x01,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(mcm_data_get_apn_name_req_msg_v01, profile_index),
};

static const uint8_t mcm_data_get_apn_name_rsp_msg_data_v01[] = {
  0x01,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(mcm_data_get_apn_name_rsp_msg_v01, resp),
  QMI_IDL_TYPE88(1, 0),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(mcm_data_get_apn_name_rsp_msg_v01, apn_name) - QMI_IDL_OFFSET8(mcm_data_get_apn_name_rsp_msg_v01, apn_name_valid)),
  0x10,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(mcm_data_get_apn_name_rsp_msg_v01, apn_name),
  MCM_DATA_MAX_APN_LEN_V01,
  QMI_IDL_OFFSET8(mcm_data_get_apn_name_rsp_msg_v01, apn_name) - QMI_IDL_OFFSET8(mcm_data_get_apn_name_rsp_msg_v01, apn_name_len)
};
...
static const qmi_idl_message_table_entry mcm_data_message_table_v01[] = {
  ...
  {sizeof(mcm_data_get_apn_name_req_msg_v01), mcm_data_get_apn_name_req_msg_data_v01},
  {sizeof(mcm_data_get_apn_name_rsp_msg_v01), mcm_data_get_apn_name_rsp_msg_data_v01},
...
static const qmi_idl_service_message_table_entry mcm_data_service_command_messages_v01[] = {
  ...
  {MCM_DATA_GET_APN_NAME_REQ_V01, QMI_IDL_TYPE16(0, 24), 4},
...
static const qmi_idl_service_message_table_entry mcm_data_service_response_messages_v01[] = {
  ...
  {MCM_DATA_GET_APN_NAME_RSP_V01, QMI_IDL_TYPE16(0, 25), 165},
