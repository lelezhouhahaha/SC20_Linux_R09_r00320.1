...
}mcm_nw_set_sys_sel_pref_req_msg_v01;
...
typedef struct {
  ...
  mcm_response_t_v01 response;
  /**<   Result code.*/
}mcm_nw_set_sys_sel_pref_resp_msg_v01;

//add by peeta
typedef struct {
  uint8_t card;
}mcm_nw_set_dual_standby_pref_req_msg_v01;
...
typedef struct {
  ...
  mcm_response_t_v01 response;
  /**<   Result code.*/
}mcm_nw_set_dual_standby_pref_resp_msg_v01;
...
//add by peeta
//nas_set_system_selection_preference
#define MCM_NW_SET_SYS_SEL_PREF_REQ_V01 0x0511
#define MCM_NW_SET_SYS_SEL_PREF_RESP_V01 0x0511
#define MCM_NW_SET_DUAL_STANDBY_PREF_REQ_V01 0x0512
#define MCM_NW_SET_DUAL_STANDBY_PREF_RESP_V01 0x0512
