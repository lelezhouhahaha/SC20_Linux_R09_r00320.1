...
/**
 * @brief cell locatro deinit function
 * @return null
 */
void ql_cell_locator_deinit(void);
 ...
 * @param[in] token string of token which want to be set.
...
/**
 * @brief  set locator query mode
 * @param[in] mode @see QLocMethod_Tag.
 * @return if success return 0, else return -1
 */
int ql_cell_locator_set_mode(int mode);
