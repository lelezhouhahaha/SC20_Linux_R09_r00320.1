...
void quec_rf_handle(const AtCmd *cmd, AtCmdResponse *response);
...
void quec_qcfg_handle(const AtCmd *cmd, AtCmdResponse *response);
void quec_odis_handle(const AtCmd *cmd, AtCmdResponse *response);
#ifdef __cplusplus
}
#endif
